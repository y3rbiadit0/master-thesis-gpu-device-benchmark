...
% ---- Metadata -------------------------------------------------------
\title{When Does GPU-Initiated Communication Pay Off?}
\subtitle{A Pattern-Oriented Study from Microbenchmarks to Conjugate Gradient}
...
\input{chapters/04-experimental-evaluation}
\input{chapters/05-related-work}
\input{chapters/06-discussion}
\input{chapters/07-conclusion}

% ---- Appendices -----------------------------------------------------
\appendix
\input{appendices/complete-backend-results}
\input{appendices/nccl-preliminary}
